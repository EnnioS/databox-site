...
export class IotDevelopmentComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    //MEADATA
    this.title.setTitle('IoT Product Development | DATABOXAI');
    this.CanonicalService.createLinkForCanonicalURL();
    this.MetaTagService.updateTag(
      {name:'description', content: 'We offer a comprehensive range of IoT product development services tailored to meet your specific needs and unlock the full potential of connected devices.'}
    );
