...
export class ImageClassificationComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('Smart Image Classification | DATABOXAI');
    this.CanonicalService.createLinkForCanonicalURL();
    this.MetaTagService.updateTag(
      {name:'description', content: 'We can help your business understand and interpret visual content, similar to how humans recognize objects or patterns in images.'}
    );
